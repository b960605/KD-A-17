*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSA17_SPFLI
*   generation date: 2022.08.22 at 16:34:52
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSA17_SPFLI        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSA17_SPFLI'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSA17_SPFLI_EXTRACT
TOTAL = ZVSA17_SPFLI_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSA17_SPFLI'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSA17_SPFLI-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSA17_SPFLI_EXTRACT
TOTAL = ZVSA17_SPFLI_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSA17_SPFLI-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSA17_SPFLI'
...
TOTAL = ZVSA17_SPFLI_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSA17_SPFLI-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSA17_SPFLI-UPD_FLAG NE SPACE.

...
FORM get_bom_data .
  ...
  DATA : lv_tabix  LIKE sy-tabix,
         gcl_maktx TYPE REF TO zclc117_0002,
         lv_msg    TYPE char100,
         lv_code,
  ...
  IF gcl_maktx IS INITIAL.
    CREATE OBJECT gcl_maktx.
  ENDIF.


*------------ Class 를 이용해서 maktx 넣기 --------------------

  CLEAR gs_mat.
  LOOP AT gt_mat INTO gs_mat.
    CLEAR : lv_tabix, lv_code, lv_msg.
    lv_tabix = sy-tabix.

    CALL METHOD gcl_maktx->get_material_text
      EXPORTING

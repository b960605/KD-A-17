*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSA1704
*   generation date: 2022.07.21 at 14:25:53
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSA1704            .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSA1704'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSA1704_EXTRACT
TOTAL = ZVSA1704_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSA1704'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSA1704-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSA1704_EXTRACT
TOTAL = ZVSA1704_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSA1704-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSA1704'
...
TOTAL = ZVSA1704_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSA1704-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSA1704-UPD_FLAG NE SPACE.

*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSA1799
*   generation date: 2022.08.01 at 10:14:02
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSA1799            .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSA1799'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSA1799_EXTRACT
TOTAL = ZVSA1799_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSA1799'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSA1799-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSA1799_EXTRACT
TOTAL = ZVSA1799_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSA1799-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSA1799'
...
TOTAL = ZVSA1799_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSA1799-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSA1799-UPD_FLAG NE SPACE.

*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSA17_SFLIGHT
*   generation date: 2022.08.22 at 16:48:07
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSA17_SFLIGHT      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSA17_SFLIGHT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSA17_SFLIGHT_EXTRACT
TOTAL = ZVSA17_SFLIGHT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSA17_SFLIGHT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSA17_SFLIGHT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSA17_SFLIGHT_EXTRACT
TOTAL = ZVSA17_SFLIGHT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSA17_SFLIGHT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSA17_SFLIGHT'
...
TOTAL = ZVSA17_SFLIGHT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSA17_SFLIGHT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSA17_SFLIGHT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVSA17_SFLIGHT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVSA17_SFLIGHT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSA17_SFLIGHT_EXTRACT
TOTAL = ZVSA17_SFLIGHT_TOTAL
